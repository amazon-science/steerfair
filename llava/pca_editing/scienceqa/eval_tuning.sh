#!/bin/bash
cd ../../eval
search_dir="/home/ubuntu/ScienceQA/data/scienceqa/stratified_attack"

combine_mode="qr"
split="test"

result_dir="../../vqa/idefics/ScienceQA/baseline_test_by_category/social_science"
output_dir="../../vqa/idefics/ScienceQA/baseline_test_by_category/social_science_outputs"
mkdir -p $output_dir
