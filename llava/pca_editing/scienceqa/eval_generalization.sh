...
result_dir="../../vqa/results/instructblip/ScienceQA/generalization/cross/test"
output_dir="../../vqa/results/instructblip/ScienceQA/generalization/cross/test_outputs"
mkdir -p $output_dir
...
--result-file ${entry2} \
--output-file  ${output_dir}/dir_${category}/${result_file_name}_output.json  \
--output-result   ${output_dir}/dir_${category}/${result_file_name}_result.json >>  ${output_dir}/dir_${category}/${result_file_name}.txt
done
done
# done
