...
if __name__ == "__main__":
    ...
    for subdir in os.listdir(head_values_dir):
        ...
        head_values = np.load(os.path.join(load_dir))
        pca_head_directions = get_pca_direction(
            head_values, n_layers, n_heads, save=True, save_dir=os.path.join(save_dir, subdir)
        )
